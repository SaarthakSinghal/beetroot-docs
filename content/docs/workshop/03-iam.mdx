...
Do not use broad policies like <code>AdministratorAccess</code>. We'll grant only the exact permissions this Lambda needs.
</Callout>
...
We read only from <code> photos-raw/* </code> and write only to <code> faces-thumbs/* </code>. This keeps access tightly scoped.
    </Callout>
  </Tab>
...
1. Click **Next**
1. **Policy name:** <code>BeetrootIngestPolicy</code>
