...
### Part 2: New AWS Client + Env vars
...
**2) Read bytes from the streaming body**
...
#### Step 1: Loop over each detected face
...
#### Step 2: Convert the face bounding box to pixels
...
#### Step 4: Save the thumbnail to memory as JPEG
...
#### Step 5: Build the thumbnail S3 path (key)
...
### Step 6: Upload to thumbs bucket
...
### Step 7: Store the key we uploaded
